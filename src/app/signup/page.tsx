...
const SignupPage = () => {
    ...
    return (
        ...
        <div className="flex flex-col items-center justify-center py-2">
            ...
            <button onClick={signUp} className="mt-2 hover:shadow-form w-100 rounded-md bg-[#6A64F1] py-3 px-8 text-center text-base font-semibold text-white outline-none">
            Sign up
            </button>
            <Link className="text-blue-400 py-3 px-8" href={"/login"}>
            Visit to login page
            </Link>
        </div>
        </div>
